...
export default function EditEventPage() {
  ...
  if (!isOrganizer) return (
    <div className="min-h-[70vh] flex items-center justify-center px-4">
      <div className="text-center max-w-sm">
        ...
        <h2 className="text-2xl font-bold text-[#F5F0EB] tracking-tight mb-2">Not your event</h2>
        <p className="text-sm mb-8" style={{ color: '#8C8680' }}>Only the organiser can edit this event.</p>
  ...
  return (
    <div className="max-w-xl mx-auto px-4 py-10">
      <Link href={`/events/${id}`} className="inline-flex items-center gap-2 text-sm mb-8 transition-colors duration-200" style={{ color: '#8C8680' }}
      ...
      <p className="text-[11px] font-mono text-[#F97316] uppercase tracking-widest mb-2">Edit event</p>
      <h1 className="text-3xl font-bold text-[#F5F0EB] tracking-tight mb-1">Edit Event</h1>
      <p className="text-sm mb-8" style={{ color: '#8C8680' }}>Update the details for your event.</p>
