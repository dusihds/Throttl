  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10">
      <div className="flex items-end justify-between mb-10">
        <div>
          <div className="h-3 w-32 rounded-full bg-white/[0.06] mb-3 animate-pulse" />
          <div className="h-8 w-40 rounded-xl bg-white/[0.06] animate-pulse" />
        </div>
        ...
        {Array.from({ length: 6 }).map((_, i) => (
          <div key={i} className="rounded-2xl overflow-hidden animate-pulse" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.06)' }}>
            ...
            <div className="p-4 flex flex-col gap-3">
              ...
              <div className="h-3 w-2/5 rounded-full bg-white/[0.05]" />
            </div>
          </div>
        ))}
      </div>
